...
func main() {
	 ...
	 * and keys with zero values like 0 or "". Here we didn’t
	 * need the value itself, so we ignored it with the
	 * blank identifier _.
	 */
	_, prs := m["k2"]
	fmt.Println("prs:", prs)

	// You can also declare and initialize a new map in the
	// same line with this syntax
